...
BOOKING_FORM_SCHEMA = SchemaDefinition(
    ...
    fields=[
        ...
        FieldSpec(key="booking_reference_number", field_type="string",  required=False, description="Booking reference or order number"),
        ...
        FieldSpec(key="vehicle_variant",          field_type="string",  required=False, description="Vehicle variant or trim level (e.g. Z8S, SX+)"),
        FieldSpec(key="vehicle_color",            field_type="string",  required=False, description="Preferred or booked vehicle colour"),
