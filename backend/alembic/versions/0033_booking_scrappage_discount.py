"""Publish Booking Form scrappage discount/bonus extraction.

Revision ID: 0033
Revises: 0032
Create Date: 2026-09-09

The Booking Form's commercial-component schema (0025) covers Sales, Buffer,
Exchange, Corporate, Loyalty, In-house Insurance, MR, OEM Referral, Other and
Free Accessory discounts as individually labelled fields, but never gained a
Scrappage Discount/Bonus field -- Audit Core's own checkpoint rules need this
value directly (a booking with a scrappage benefit but no scrappage document
on file should be flagged), and there was nowhere to read it from. Same
publish-a-new-immutable-profile-version pattern as 0025: clone the current
published Booking Form profile, add the one new field.
"""
...
_ACTOR = "migration.0033.booking-scrappage-discount"
    ...
    profile_id = conn.execute(
        sa.text(
            ...
            INSERT INTO docintel.extraction_profiles (
                ...
                'Booking Form Scrappage Discount Extraction v1.6', 'DRAFT',
